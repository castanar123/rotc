...
from api.pending_approvals import router as pending_approvals_router
...
# Create FastAPI app
app = FastAPI(
    title="ROTC Unrestricted Document Generation API",
    description="Unrestricted document generation system that bypasses approval status checks",
    version="1.0.0",
