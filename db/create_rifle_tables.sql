...
-- Execute this script to create the required tables for rifle management
...
-- Sample rifle data will be inserted separately after table creation
...
-- Log entries will be created when rifles are actually added
-- INSERT INTO rifle_logs (rifle_id, action, performed_by, details) 
-- SELECT r.id, 'created', 1, CONCAT('Rifle ', r.rifle_number, ' added to inventory')
-- FROM rifles r
-- WHERE r.rifle_number IN ('R001', 'R002', 'R003', 'R004', 'R005', 'R006', 'R007', 'R008', 'R009', 'R010');
