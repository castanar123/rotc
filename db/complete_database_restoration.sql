...
-- ========================================
-- MIGRATION TABLES (from migrations folder)
-- ========================================
...
-- Registration fields view
CREATE OR REPLACE VIEW `registration_fields_view` AS
SELECT 
    'student_id' as field_name,
    'Student ID' as field_label,
    'text' as field_type,
    TRUE as is_required,
    1 as sort_order
UNION ALL
