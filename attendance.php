...
<body data-role="<?php echo $_SESSION['role']; ?>">
    ...
    <script>
        ...
        function processAttendance(qrData) {
            ...
            // Extract identifiers from QR
            let profileId = null;
            let studentId = null;
            let cadetName = null;

            // 1) Try base64 permanent format
            try {
            ...
            const eventName = `Daily Attendance ${todayStr}`;
